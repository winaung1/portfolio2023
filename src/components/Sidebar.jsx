...
function Sidebar() {
  ...
  return (
    <div className={showSideBar ? ' z-[6000] transition-all duration-300 ease-linear fixed md:flex flex-col gap-4 bg-[#17181B] h-screen w-[200px] md:left-0 top-0 text-gray-600' : '-left-60 z-[6000] transition-all duration-300 ease-linear fixed md:flex flex-col gap-4 bg-[#17181B] h-screen w-[200px] md:left-0 top-0 text-gray-600'}>
    <div className='relative'>
      <img className=' object-cover h-80 w-full' src="https://st3.depositphotos.com/15648834/17930/v/450/depositphotos_179308458-stock-illustration-unknown-person-silhouette-profile-picture.jpg" alt="" />
    ...
    <div className='flex text-2xl z-[9000] absolute bottom-4 left-0 right-0 justify-center items-center space-x-4'>
      <FaYoutube className='hover:white'/>
      <FaLinkedin className='hover:white'/>
      <FaGithub className='hover:white'/>
    </div>
      <div className={'w-fit mx-auto flex flex-col gap-4 pt-4'}>
